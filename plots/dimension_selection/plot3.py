...
arr = last_knns_distance.reshape(last_knns_distance.shape[0],last_knns_distance.shape[1]).T
arr = arr.round(1)
c_arr = np.zeros((len(arr),len(arr[0])))
print(arr)
...
plt.savefig(f'dimesnion_selection/plot3/plot3.png', bbox_inches='tight', pad_inches = 0, dpi=400)
#plt.show()